    ...
    return (
      <div className="min-h-screen md:py-barn-section md:px-4 md:bg-white">
        <div className="w-full md:w-4/5 md:mx-auto">
          ...
          <div className="bg-white md:rounded-2xl md:shadow-xl p-4 md:p-8 mb-8" style={{backgroundImage: 'url(/background-white-green.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', minHeight: '100vh'}}>
          {/* Header */}
